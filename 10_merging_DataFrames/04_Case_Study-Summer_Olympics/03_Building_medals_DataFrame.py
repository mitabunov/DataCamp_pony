...
You have a sequence of files summer_1896.csv, summer_1900.csv, ..., summer_2008.csv, one for each Olympic edition
(year).
...
# CSV files for each olipics are not available to load.
# Instead late would be used a combined file which would be a concatenated file generated by below code.
print(50*'*'+'  \n'+'NO FILES AVAILABLE TO CONCATENATE!\n'+50*'*'+'\n\n')
