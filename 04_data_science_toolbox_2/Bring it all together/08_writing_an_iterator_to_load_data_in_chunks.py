...
length, say, 100. E.g., with the pandas package (imported as pd), you can do pd.read_csv(filename, chunksize=100).
...
Indicators data 'world_ind_pop.csv', to look at the urban population indicator for numerous countries and years.
...
df_reader = pd.read_csv(r'../_datasets/world_ind_pop.csv', chunksize=10)
