...
Read more here (http://www.stat.ucla.edu/projects/datasets/seaslug-explanation.html).

Due to the header, if you tried to import it as-is using np.loadtxt(), Python would throw you a ValueError and tell you
that it could not convert string to float. There are two ways to deal with this: firstly, you can set the data type
